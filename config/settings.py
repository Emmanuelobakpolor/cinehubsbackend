...
ALLOWED_HOSTS = [
    'cinehubsbackend-production.up.railway.app',
    'localhost',
    '127.0.0.1',
]
...
# No upload size limit — files are streamed to Cloudinary.
...
PAYMENT_REDIRECT_URL = config(
    ...
    default='https://cinehubsbackend-production.up.railway.app/api/payments/verify/'
)
